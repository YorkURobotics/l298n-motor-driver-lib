 ...
 */
void L298N::L298N(byte pinEnable, byte pinIN1, byte pinIN2)
{
 ...
 *                  - value of true indicates clockwise rotation
 *                  - value of false indicates counterclockwise rotation
